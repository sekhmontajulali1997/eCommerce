...
const Shop = () => {
  ...
  const handleFilterCategory = (e) => {
    ...
    if (checked) {
      let all = [...categoryFilter, value];
      setcategoryFilter(all);
    } else {
      let notCheckedIds = categoryFilter.filter(
        (category) => category !== value
      );
      setcategoryFilter(notCheckedIds);
    }
  };
  useEffect(() => {
              ...
              <div className="shop-sidebar">
                ...
                <div className="sidebar-box">
                  ...
                  <div className="price-filter-wrap">
                      ...
                      <div className="noUi-base">
                        <div className="noUi-connects">
                          <div
                            ...
                            style={{
                              transform:
                                "translate(8.16327%, 0px) scale(0.510204, 1)",
                            }}
                          />
                        </div>
                        <div
                    ...
                    <button id="filterPrice" className="def-btn" onClick={()=> window.location.reload()}>
                      Clear Filter 
                    </button>
                  </div>
                </div>
              ...
              <div className="row g-lg-4 g-3">
                {Product?.length > 0
                  ? Product.map((pItem) => {
                      return (
                        <div
                          className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6"
                          key={pItem.id}
                        >
                          <div className="single-product-card">
                            ...
                            <div className="part-txt">
                              ...
                              <p className="dscr">
                                ...
                                adipisicing elit. Ducimus aliquid laborum
                                aperiam dolores. Dignissimos at harum corporis
                                qui illo nam fugit recusandae ratione odit neque
